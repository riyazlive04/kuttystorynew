...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "KuttyStory books start at Rs. 749 for the instant PDF and Rs. 1,299 for the premium printed hardcover, with free delivery anywhere in India. Prices vary a little by title and page count, and 2 or more books get 20% off with the code STORY20. Payment is in Indian Rupees through Razorpay - UPI, credit card, debit card or net banking.",
  },
  {
